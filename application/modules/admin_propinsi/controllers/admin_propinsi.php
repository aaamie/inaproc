...
class admin_propinsi extends MX_Controller  {
	...
	function __construct()
	{
		...
		$this->load->model("admin_propinsi",'propinsi');
	...
	{	
		...
		$jum_record = $this->propinsi->getTotal($this->table,"propinsi",$sch1_parm,$sch2_parm);
		...
		#record
		$query = $this->propinsi->getList($this->table,"propinsi",$per_page,$lmt,$sch1_parm,$sch2_parm);
		$list = array();
		if($query->num_rows() > 0){
