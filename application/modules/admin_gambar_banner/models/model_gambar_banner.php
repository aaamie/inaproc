<?php
class model_gambar_banner extends CI_Model {
...
function setDelete($table,$id)
	...
	function setFileUpload($file_image,$file_image_tmp,$file_image_old)
	{
		...
		$h = 280;
 		...
 		$this->image_moo->load($file_image_tmp)->resize_crop($w,$h)->save("./uploads/gambar_banner/".$file_image);
		$this->image_moo->load($file_image_tmp)->resize_crop(125,125)->save("./uploads/gambar_banner/thumbs/".$file_image);
	...
	{
		if(file_exists("uploads/gambar_banner/".$file_image)){ unlink("uploads/gambar_banner/".$file_image); }
		if(file_exists("uploads/gambar_banner/thumbs/".$file_image)){ unlink("uploads/gambar_banner/thumbs/".$file_image); }
	}
