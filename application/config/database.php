...
$db['default']['password'] = '';
$db['default']['database'] = 'lkpp-inaproc';
...
$db['postgre']['password'] = '3o1o1987!';
$db['postgre']['database'] = 'dce-inaproc';
...
/* $db['postgre']['hostname'] = '10.1.31.31';
$db['postgre']['port']     = '1234';
$db['postgre']['username'] = 'postgres';
$db['postgre']['password'] = '';
$db['postgre']['database'] = 'dce_inaproc';
$db['postgre']['dbdriver'] = 'postgre';
$db['postgre']['dbprefix'] = '';
$db['postgre']['pconnect'] = TRUE;
$db['postgre']['db_debug'] = TRUE;
