...
<section class="search-custom">
	<div class="container">
		<div class="breadcrumb-sub">
			<a href="#" class="active">Pengadaan</a> &raquo; <a href="#">Berdasar Propinsi</a> <!-- &raquo; Pengadaan Barang -->
		</div>
	</div>
</section>
			...
			<div class="row no-margin">
				...
				<div class="col-md-12 col-sm-12 col-xs-12 box-lpse-list">
					...
					<div class="col-md-4 col-sm-4 col-xs-12 mb-20">
						<a href="<?php echo base_url()?>pengadaan/index/null/null/null/null/null/null/null"><?php echo $value['total'] ?> Pengadaan</a>
						<br/>
					</div>
					...
					<!-- 	<p>Pengumuman Lelang : aaa</P> -->
						...
						<a href="<?php echo base_url()?>pengadaan/index/null/null/null/null/null/null/null" class="btn btn-detail">Detail</a> 
					</div>
				</div>
				<?php endforeach?>
