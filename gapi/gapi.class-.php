...
class gapi
{
   ...
   * @param Int $max_results OPTIONAL: Max results returned
   */
  public function requestReportData($report_id, $dimensions, $metrics, $sort_metric=null, $filter=null, $segment=null,$start_date=null, $end_date=null, $start_index=1, $max_results=30)
  {
  ...
  private function curlRequest($url, $get_variables=null, $post_variables=null, $headers=null)
  {
    ...
    curl_setopt($ch,CURLOPT_PROXY, '10.1.30.30:3128');
